...
namespace Auction.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(AuctionUserManager userManager, AuctionSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new AuctionUser { UserName = model.Username, Email = model.Email };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new AuctionUser { UserName = model.Email, Email = model.Email };
